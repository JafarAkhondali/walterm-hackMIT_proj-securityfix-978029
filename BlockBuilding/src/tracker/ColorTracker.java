...
public class ColorTracker {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Mat convert = new Mat();
		hsvThresh.convertTo(convert, CvType.CV_32SC1); // need image to be
														// 32SC1, not sure why.
		Imgproc.findContours(convert, contours, new Mat(),
		...
		// Get the rectangle that fits around the boundary of the largest
		// contour
